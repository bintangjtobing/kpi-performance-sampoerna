...
<body>
        ...
        <table class="category-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td
                        class="percentage {{ $data['achievement_rate'] >= 70 ? 'good' : ($data['achievement_rate'] >= 50 ? 'average' : 'poor') }}">
                        {{ $data['achievement_rate'] }}%
                    </td>
                    <td
                        class="percentage {{ $data['average_percentage'] >= 70 ? 'good' : ($data['average_percentage'] >= 50 ? 'average' : 'poor') }}">
        ...
        <table class="daily-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td
                        class="percentage {{ $progress->overall_percentage >= 70 ? 'good' : ($progress->overall_percentage >= 50 ? 'average' : 'poor') }}">
    ...
    <div class="footer">
        <p>This report was generated automatically by Report Daily Helper-PMI System</p>
