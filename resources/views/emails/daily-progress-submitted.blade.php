...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>PT. Sampoerna Performance System</p>
        ...
        <div class="content">
            ...
            <div class="success-message">
                ...
                <p>Terima kasih telah mengirimkan laporan harian KPI Anda pada {{ $dailyProgress->created_at->format('d F Y') }}. Laporan Anda telah berhasil diproses dan disimpan dalam sistem.</p>
            </div>
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-number">{{ $dailyProgress->progressItems->where('percentage', '>=', 100)->count() }}</div>
            ...
            <div class="progress-items">
                ...
                <div class="progress-item">
                    <h4>{{ $item->kpi_item }}</h4>
                    <p><strong>Target:</strong> {{ number_format($item->target) }} {{ $item->unit }} | <strong>Aktual:</strong> {{ number_format($item->actual) }} {{ $item->unit }}</p>
                    <div class="progress-bar">
                        <div class="progress-bar-fill" style="width: {{ min($item->percentage, 100) }}%"></div>
                    </div>
                    <p style="margin-top: 8px; font-size: 13px;">{{ number_format($item->percentage, 1) }}% dari target</p>
                </div>
                @endforeach
            </div>
            ...
            <div class="attachment-info">
                <h3>📎 Lampiran</h3>
                <p>Laporan harian Anda dalam format PDF telah dilampirkan pada email ini. Anda dapat mengunduh dan menyimpannya sebagai dokumentasi.</p>
            </div>
            @endif
        </div>
        ...
        <div class="footer">
            <p>
                Email otomatis dari sistem KPI Sampoerna<br>
