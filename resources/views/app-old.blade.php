            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-xl font-bold text-gray-900">Report Daily Helper-PMI</h1>
                    </div>
                        ...
                        <form @submit.prevent="submitProgress()">
                            <div class="space-y-8">
                                ...
                                <div class="bg-gray-50 rounded-lg p-6">
                                    ...
                                    <div class="mb-4">
                                        <input type="file" @change="handleFileUpload($event)" multiple accept="image/*"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            <div x-show="currentStep === 'result'" class="max-w-2xl mx-auto">
                <div class="bg-white rounded-xl shadow-lg p-8 text-center">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 mb-6">
                        ...
                        <div class="text-3xl font-bold text-blue-600 mb-2" x-text="Math.round(overallPercentage) + '%'">
                        </div>
